                ...
                >
                  ...
                  >
                    ...
                    orderedImages.length === 0 ? (
                      ...
                      >
                        {currentPage?.textElements?.map((el, idx) => {
                          const bounds = {
                            left: el.x || 0,
                            right: (el.x || 0) + (el.width || 0),
                            top: (el.y || 0),
                            bottom: (el.y || 0) + (el.height || 0)
                          };
                          const css = toCssBounds(currentPage, pageHeight, scale, bounds);
                          return (
                            <div
                              ...
                              style={{
                                ...
                                width: css.width,
                                height: css.height,
                                backgroundColor: activeGroupId === `text-${idx}` ? "rgba(0, 120, 255, 0.2)" : "transparent",
                                border: activeGroupId === `text-${idx}` ? "1px solid #0078ff" : "none",
                                cursor: "pointer",
                                pointerEvents: "auto",
                              }}
                              onClick={() => setActiveGroupId(`text-${idx}`)}
                            />
                          );
                        })}
                      </div>
