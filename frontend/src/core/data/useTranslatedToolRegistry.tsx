  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      vectorExport: {
        ...
        name: t("home.vectorExport.title", "Vector Export"),
        component: lazy(() => import("@app/tools/Convert")),
        description: t(
          "home.vectorExport.desc",
          "Export PDF as a vector-based archival document (PDF/A)",
        ),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
        endpoints: ["pdf-to-pdfa"],
        operationConfig: convertOperationConfig,
        automationSettings: null,
        synonyms: ["vector", "export", "pdfa", "archival"],
      },
    };
